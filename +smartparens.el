...
;; Do note that an older FAQ for Doom indicated that there's no keybindings for smartparens because Doom offers Evil by default and this has similar things with text objects.

;; Smartparens - Practicalli config and key bindings
;; https://github.com/practicalli/doom-emacs-config/blob/main/%2Bsmartparens.el
...
;; Another interesting (more involved) approach:
